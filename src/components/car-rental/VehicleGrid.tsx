        ...
        <AnimateIn animation="fade-up">
          <div className="text-center max-w-[560px] mx-auto mb-12">
            ...
            <p className="text-[#666] text-[15px] mt-3">
              Every car below is on the yard right now. Open one to see the
              photos, the rego and how to apply.
            </p>
          </div>
        </AnimateIn>
          ...
          {rentalVehicles.map((vehicle, i) => (
            ...
            >
              <button
                ...
                className="group text-left w-full bg-white rounded-[16px] overflow-hidden border border-[#e8e8f0] cursor-pointer hover:shadow-[0_6px_24px_rgba(0,0,0,0.1)] hover:-translate-y-1 hover:border-[#d6d8f5] transition-all duration-300"
              >
                <div className="h-[160px] relative bg-[#f0f0ff] overflow-hidden">
                  ...
                  />
                  <div className="absolute top-3 left-3 bg-white/95 text-[#1a1a2e] w-7 h-7 rounded-full flex items-center justify-center text-[11px] font-bold shadow-sm">
                    {vehicle.number}
                  </div>
                ...
                <div className="p-4">
                  ...
                  <p className="text-[12px] text-[#7f85f7] font-semibold mt-4 flex items-center gap-1.5">
                    View details
                    <ArrowRight
                      size={13}
